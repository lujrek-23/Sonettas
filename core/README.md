<div align="center">
  ...
  <p align="center">
    ...
    <br />
    <em>The core library powering <a href="https://github.com/HuasicApp/Huasic">Huasic</a> — a high-performance, privacy-focused YouTube Music client for Android.</em>
  </p>

  <p align="center">
    <img src="https://img.shields.io/github/v/release/HuasicApp/core?style=for-the-badge&color=6366f1&labelColor=1e1e2e&logo=github" alt="Latest Version" />
    <img src="https://img.shields.io/github/license/HuasicApp/core?style=for-the-badge&color=6366f1&labelColor=1e1e2e" alt="License" />
    ...
    <img src="https://img.shields.io/github/stars/HuasicApp/core?style=for-the-badge&color=6366f1&labelColor=1e1e2e&logo=github" alt="Stars" />
  </p>

  <a href="https://star-history.com/#HuasicApp/core&HuasicApp/Huasic&Date">
    <picture>
      <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/svg?repos=HuasicApp/core,HuasicApp/Huasic&type=Date&theme=dark" />
      <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/svg?repos=HuasicApp/core,HuasicApp/Huasic&type=Date" />
      <img alt="Star History Chart" src="https://api.star-history.com/svg?repos=HuasicApp/core,HuasicApp/Huasic&type=Date" width="600" />
    </picture>
  </a>
...
This is the standalone InnerTube API core extracted from [Huasic](https://github.com/HuasicApp/Huasic). It provides a complete Ktor-based HTTP client for interacting with YouTube Music's InnerTube API, including request signing, response parsing, proxy rotation, and playback authentication.
...
The diagram below shows how this library fits into the Huasic app and how data flows through the layers.

```mermaid
flowchart TB
    subgraph Android["Huasic App (Android)"]
...
**Data flow:**
1. User interacts with Huasic's Compose UI
