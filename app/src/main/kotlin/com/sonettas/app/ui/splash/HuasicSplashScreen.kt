 ...
 * - Upper third: Huasic Seal (drawn with stroke animation)
...
private val Vellum = Color(0xFFEDE9DD)
private val Ink = Color(0xFF1A1A1A)
private val Stone = Color(0xFF6B6862)
...
/**
 * Draw the Huasic Seal — outer ring + Greek meander + central waveform/tuning fork.
 * Stroke progress animates the draw.
 */
@Composable
private fun HuasicSealCanvas(
    progress: Float,
