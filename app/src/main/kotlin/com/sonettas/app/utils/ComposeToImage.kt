...
import com.sonettas.app.ui.component.LyricsShareImageOptions
import java.io.File
...
object ComposeToImage {
    ...
    suspend fun createLyricsImage(
        ...
        glassStyle: com.sonettas.app.ui.component.LyricsGlassStyle? = null,
        shareOptions: LyricsShareImageOptions = LyricsShareImageOptions(),
    ): Bitmap =
        withContext(Dispatchers.Default) {
            val style = glassStyle ?: com.sonettas.app.ui.component.LyricsGlassStyle.FrostedDark
        ...
        return if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
            val contentValues =
                ContentValues().apply {
                    ...
                    put(MediaStore.MediaColumns.RELATIVE_PATH, Environment.DIRECTORY_PICTURES + "/Sonettas")
                }
            val uri =
